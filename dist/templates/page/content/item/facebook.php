...
// Start Item Inner Container
  ...
  $item .= '<div class="cdm-item ' . $item_name . '" data-facebook-id="' . get_sub_field('facebook_id', $item_id) . '" data-facebook-posts="' . get_sub_field('facebook_posts', $item_id) . '">';

// Start Item Content
  
  $item .= '<p>No posts available</p>';
